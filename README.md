...
![main_UI](TokenBenchy/app/assets/figures/figures/main_window.png)
...
**Viewer:** benchmark plots are visualized here, including box plot with token size distribution, hisrograms of token length by tokenizer, tokens generated by decode method and direct extraction from vocabulary and many more. 
