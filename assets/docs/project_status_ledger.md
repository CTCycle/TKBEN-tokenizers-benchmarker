...
| ui.cross-benchmark-workflow | PARTIAL | Benchmark wizard, report manager, baseline selection, clone eligibility, tags, dashboard customization, and populated report rendering. | V-20260923 at `f736f938`: the local UI wizard generated a report from a two-document CSV and WordLevel tokenizer; the completed report rendered and the same ID loaded after reload. Nine focused Cross Benchmark and benchmark API E2E cases passed. See the [T2-06 QA record](../../assets/QA/tkben-t2-06-cross-benchmark-wizard-20260923.md). | T2-06 covers local report creation and reload. Live report-manager, baseline, clone, tag, customization, data-table, and responsive interactions remain outside this evidence; the screenshot also shows a single-tokenizer tick label close to its axis title. | — | 2026-09-23 | E2E + manual | [benchmark dashboard](ui/benchmark_dashboard.md), [experience](ui/experience.md), [cross-benchmark E2E](../../app/tests/e2e/test_cross_benchmark_dashboard.py), [T2-06 QA record](../../assets/QA/tkben-t2-06-cross-benchmark-wizard-20260923.md) | Validate the remaining live report-manager and dashboard interactions; keep responsive coverage on its separate matrix before promoting the full page scope. |
