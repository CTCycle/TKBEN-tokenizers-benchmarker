...
This closes only the local cancellation/rerun slice: hosted CI remains unvalidated, Hugging Face and PostgreSQL gates remain blocked, responsive coverage remains untested, and the broader Cross Benchmark workflow stays PARTIAL.
...
| benchmark.execution-and-reporting | VALIDATED | Benchmark admission, custom-tokenizer execution, schema-3/report-5 report persistence, list/load, metadata, and physical deletion. | V-20260923: T2-07 at `cc91fec1` exercised page cancellation of a 10,000-document run after API progress reached 20%, verified terminal cancellation with no report, then persisted and rendered the immediate two-document rerun. Focused frontend/backend gates, lint, and production build passed; see the [T2-07 QA record](../../assets/QA/tkben-t2-07-benchmark-cancellation-20260923.md) and [T2-06 QA record](../../assets/QA/tkben-t2-06-cross-benchmark-wizard-20260923.md). | Full multi-tokenizer/provider and long-running performance coverage is not implied. | — | 2026-09-23 | E2E + unit + manual | [benchmark contract](architecture/benchmark_contract.md), [execution and data flow](architecture/execution_and_data_flow.md), [benchmark E2E](../../app/tests/e2e/test_benchmarks_api.py) | Continue multi-tokenizer/provider and performance campaigns; revalidate when execution or cancellation behavior changes. |
...
| ui.cross-benchmark-workflow | PARTIAL | Benchmark wizard, report manager, baseline selection, clone eligibility, tags, dashboard customization, and populated report rendering. | V-20260923: T2-06 generated and reloaded a local report; T2-07 at `cc91fec1` added page-level cancellation, verified terminal cancel/no report after API progress reached 20%, and rendered the immediate two-document rerun. See the [T2-06 QA record](../../assets/QA/tkben-t2-06-cross-benchmark-wizard-20260923.md) and [T2-07 QA record](../../assets/QA/tkben-t2-07-benchmark-cancellation-20260923.md). | T2-07 covers local cancel/rerun only. Live report-manager, baseline, clone, tag, customization, data-table, and responsive interactions remain outside this evidence; the T2-06 screenshot also shows a single-tokenizer tick label close to its axis title. | — | 2026-09-23 | E2E + manual | [benchmark dashboard](ui/benchmark_dashboard.md), [experience](ui/experience.md), [cross-benchmark E2E](../../app/tests/e2e/test_cross_benchmark_dashboard.py), [T2-06 QA record](../../assets/QA/tkben-t2-06-cross-benchmark-wizard-20260923.md) | Validate the remaining live report-manager and dashboard interactions; keep responsive coverage on its separate matrix before promoting the full page scope. |
