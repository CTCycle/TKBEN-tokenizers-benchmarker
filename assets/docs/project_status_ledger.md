...
The historical bootstrap baseline is checkout e318852 (tag v4.4.0). The v4.5.0
release commit is `f8dee1da9084138bd52f3d08437269d3821ba5d6`, and annotated tag
`v4.5.0` targets it. The post-release closure commit
`1dd59e755bdca5f16be354a75b7ac053ac0d2e17` is now shared by remote `main` and
`develop`. Historical v4.4.0 release/tag/CI evidence remains retained for
provenance.
...
jobs succeeded. V-20260925 also records the current release suite at release
commit `f8dee1da9084138bd52f3d08437269d3821ba5d6`; hosted CI run
[36158666979](https://github.com/CTCycle/TKBEN-tokenizers-benchmarker/actions/runs/36158666979)
passed for that exact SHA with successful backend and frontend jobs. Remote
`main` and `develop` are synchronized at post-release closure commit
`1dd59e755bdca5f16be354a75b7ac053ac0d2e17`; annotated tag `v4.5.0` has object
SHA `4a49670c25a224f8218d7feb2fe07ec8e8690ae2`, and the
[public source-only release](https://github.com/CTCycle/TKBEN-tokenizers-benchmarker/releases/tag/v4.5.0)
is published. T5-06 is now PASS. The public Hugging Face tokenizer
...
the request, so physical disk-exhaustion recovery remains PARTIAL. The
pre-release GitHub API audit identified v4.4.0 as the latest public release at
that time; its tag and CI evidence remains in the [release audit](../../assets/QA/tkben-open-validation-debt-20260925/release-audit.json)
and [QA record](../../assets/QA/tkben-open-validation-debt-20260925/README.md).
The subsequent v4.5.0 publication is recorded in the current T5-06 closure
below.
...
V-20260925 re-audits the current `develop` checkout at `f83424f` against the
remaining validation debt. The isolated backend suite passed 517/517, Ruff
passed with the known protected-cache warning, BasedPyright reported 0 errors,
the 63 frontend unit tests, lint, and production build passed, and the
official launcher plus in-app browser rendered the current Dataset,
Tokenizers, Cross Benchmark, and Settings empty/default states. No application
defect was reproduced. T4-03 remains BLOCKED because no successful authorized
gated-repository download/report exists; the user has deferred this external,
non-blocking check. Physical disk exhaustion remains PARTIAL because host
authorization denied the bounded-volume attempt and is also deferred as
optional validation debt. T5-06 was PARTIAL at this pre-release audit; its
subsequent v4.5.0 closure is recorded below. See the [validation-gate
re-audit](../../assets/QA/tkben-validation-gate-recheck-20260925/README.md).
...
| integration.huggingface-discovery-and-download | PARTIAL | Live Hugging Face tokenizer discovery, metadata filtering, gated access, repository download, and provider-backed tokenizer report flow. | V-20260925: the supplied key authenticated through Hub `whoami`; public `bert-base-uncased` discovery, download, persisted report 1 (vocabulary size 30,522), rendered reload, and tokenizer cleanup passed. Gated discovery returned three repositories; all three download jobs failed, so gated access is not validated. See the [HF provider evidence](../../assets/QA/tkben-open-validation-debt-20260925/hf-provider-flow-evidence.json), [authentication evidence](../../assets/QA/tkben-open-validation-debt-20260925/hf-provider-auth-evidence.json), and [key-storage evidence](../../assets/QA/tkben-open-validation-debt-20260925/hf-key-storage-evidence.json). | No successful authorized gated download or gated report is evidenced. | Requires an already-authorized gated repository that completes download and report generation; the user has deferred this external check as non-blocking. | 2026-09-25 | Integration + E2E + manual | [backend API](architecture/backend_api.md), [testing and quality](coding/testing_and_quality.md), [tokenizer E2E](../../app/tests/e2e/test_tokenizers_api.py), [open validation debt QA record](../../assets/QA/tkben-open-validation-debt-20260925/README.md) | Leave T4-03 deferred; rerun only if the external repository-authorization check is explicitly selected. |
...
| Component | Status | Scope | Evidence | Known Issues | Blocker | Last Validated | Validation Level | Related Docs | Next Action |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| deployment.source-only-local | VALIDATED | Supported Windows x64 source-folder distribution, current version alignment, and local production frontend artifact. | V-20260925: release commit `f8dee1da9084138bd52f3d08437269d3821ba5d6` passed the local CI-equivalent suite; hosted CI run [36158666979](https://github.com/CTCycle/TKBEN-tokenizers-benchmarker/actions/runs/36158666979) passed both jobs; remote `main` and `develop` are synchronized at closure commit `1dd59e755bdca5f16be354a75b7ac053ac0d2e17`; annotated tag `v4.5.0` and the [public source-only release](https://github.com/CTCycle/TKBEN-tokenizers-benchmarker/releases/tag/v4.5.0) point to the verified release commit. | T4-03 gated Hugging Face access and physical low-disk recovery remain separately bounded validation debt. | — | 2026-09-25 | manual + integration + hosted CI | [release procedure](runtime/release.md), [deployment](runtime/deployment.md), [system overview](architecture/system_overview.md), [T5-06 QA record](../../assets/QA/tkben-t5-06-current-candidate-20260925/README.md) | Revalidate after release-process or source-distribution changes. |
...
| test-infrastructure.local-quality-gates | VALIDATED | Backend compile, Ruff, BasedPyright, SQLite initialization, unit tests, OpenAPI smoke, frontend lint, unit tests, and production build. | V-20260925: release implementation revision `f8dee1da9084138bd52f3d08437269d3821ba5d6` passed compileall, Ruff, BasedPyright (0 errors), Alembic initialization at `0005_managed_job_lifecycle`, 517 backend unit tests, OpenAPI smoke, frontend lint, 63 frontend unit tests, and production build. | Hosted CI, full browser E2E outside this campaign, and provider/database gates remain separate. | — | 2026-09-25 | unit + E2E + integration | [testing and quality](coding/testing_and_quality.md), [CI workflow](../../.github/workflows/ci.yml), [test runner](../../app/tests/run_tests.bat), [T5-06 QA record](../../assets/QA/tkben-t5-06-current-candidate-20260925/README.md) | Keep hosted and live-provider gates explicit in future reports. |
| test-infrastructure.hosted-ci-and-release-evidence | VALIDATED | Hosted CI result, public release/tag commit correlation, and detailed QA evidence. | V-20260925: release commit `f8dee1da9084138bd52f3d08437269d3821ba5d6` passed hosted CI run [36158666979](https://github.com/CTCycle/TKBEN-tokenizers-benchmarker/actions/runs/36158666979), with both backend and frontend jobs successful; remote `main` and `develop` are aligned at closure commit `1dd59e755bdca5f16be354a75b7ac053ac0d2e17`; annotated tag `v4.5.0` and the [public GitHub Release](https://github.com/CTCycle/TKBEN-tokenizers-benchmarker/releases/tag/v4.5.0) target the release commit. | T4-03 gated Hugging Face access and physical low-disk recovery remain separate validation debt. | — | 2026-09-25 | hosted CI + manual | [CI workflow](../../.github/workflows/ci.yml), [release procedure](runtime/release.md), [T5-06 QA record](../../assets/QA/tkben-t5-06-current-candidate-20260925/README.md) | Revalidate after release-process changes. |
...
| --- | --- | --- | --- |
| data.large-file-and-disk-exhaustion | PARTIAL | V-20260924 simulated `SQLITE_FULL` cleanup and same-name retries for upload and dataset-backed import. A small fixed-size VHD was attempted on 2026-09-25, but host OS authorization denied provisioning before a filesystem-full scenario could run; no VHD artifact remains. Physical exhaustion and recovery are still untested. The V-20260925 re-audit found no new path to execute the bounded-volume scenario. This remains optional, deferred validation debt and is not a current blocker. See the [dataset storage QA record](../../assets/QA/tkben-data-upload-storage-20260924/README.md), [open validation debt QA record](../../assets/QA/tkben-open-validation-debt-20260925/README.md), and [validation-gate re-audit](../../assets/QA/tkben-validation-gate-recheck-20260925/README.md). | MEDIUM |
| integration.huggingface-discovery-and-download | PARTIAL | Public discovery, download, report persistence, rendered reload, and cleanup passed on 2026-09-25. The supplied key authenticated successfully, but no authorized gated-repository download/report was completed. The user has deferred this external check, so T4-03 remains `BLOCKED` without being a current local validation blocker. See the [HF provider evidence](../../assets/QA/tkben-open-validation-debt-20260925/hf-provider-flow-evidence.json) and [validation-gate re-audit](../../assets/QA/tkben-validation-gate-recheck-20260925/README.md). | HIGH |

### Current release gate

The current application release commit is `f8dee1da9084138bd52f3d08437269d3821ba5d6`.
The local release suite passed, and hosted CI run
[36158666979](https://github.com/CTCycle/TKBEN-tokenizers-benchmarker/actions/runs/36158666979)
passed for that exact SHA with both jobs successful. Remote `main` and
`develop` are synchronized at closure commit
`1dd59e755bdca5f16be354a75b7ac053ac0d2e17`; annotated tag `v4.5.0` points to
the release commit, and the [public source-only release](https://github.com/CTCycle/TKBEN-tokenizers-benchmarker/releases/tag/v4.5.0)
is published. Release readiness is now VALIDATED. T4-03 is still BLOCKED
pending an already-authorized gated Hugging Face repository; physical low-disk
recovery remains PARTIAL pending a host-authorized bounded volume. See the
[T5-06 QA record](../../assets/QA/tkben-t5-06-current-candidate-20260925/README.md).
...
| T4-03 | yes | no | BLOCKED | The supplied key authenticated to Hub, but no authorized gated download succeeded across three discovered candidates; no gated report or access-term acceptance occurred. The user has deferred this external repository-authorization check as non-blocking; no application-side PASS is claimed. See the [HF provider evidence](../../assets/QA/tkben-open-validation-debt-20260925/hf-provider-flow-evidence.json) and [validation-gate re-audit](../../assets/QA/tkben-validation-gate-recheck-20260925/README.md). |
...
| T5-06 | yes | yes | PASS | V-20260925: release commit `f8dee1da9084138bd52f3d08437269d3821ba5d6` passed the local release suite and exact hosted CI run [36158666979](https://github.com/CTCycle/TKBEN-tokenizers-benchmarker/actions/runs/36158666979) with successful backend and frontend jobs. Remote `main` and `develop` were synchronized at closure commit `1dd59e755bdca5f16be354a75b7ac053ac0d2e17`, annotated tag `v4.5.0` was pushed to the release commit, and the [public source-only GitHub Release](https://github.com/CTCycle/TKBEN-tokenizers-benchmarker/releases/tag/v4.5.0) was published. See the [T5-06 QA record](../../assets/QA/tkben-t5-06-current-candidate-20260925/README.md) for the release boundary and remaining independent limits. |
...
| v4.4.0 report tags, benchmark cloning, dashboard persistence, chart controls, and cache/launcher cleanup | Included in the v4.4.0 tagged source-only release; detailed live evidence is retained as historical provenance. | [v4.4.0 release notes](runtime/release.md#v4.4.0-release-notes) |
