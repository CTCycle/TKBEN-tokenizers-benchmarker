...
`v4.5.0` targets it. Remote `main` and `develop` were synchronized after the
release closure and remained aligned through the documentation-only evidence
updates. Historical v4.4.0 release/tag/CI evidence remains retained for
provenance.
...
`main` and `develop` are synchronized after the release closure and remained
aligned through the documentation-only evidence updates; annotated tag
`v4.5.0` has object SHA `4a49670c25a224f8218d7feb2fe07ec8e8690ae2`, and the
...
`develop` remained synchronized through the documentation-only evidence
updates; annotated tag `v4.5.0` points to the release commit, and the [public
