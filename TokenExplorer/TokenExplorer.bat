...
:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
:: Check if the 'TokenExplorer' environment exists when not using a custom environment
:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
:initial_check
if /i "%use_custom_environment%"=="false" (
    set "env_name=TokenExplorer"
...
if "%env_exists%"=="true" (
    ...
    if /i "%env_name%"=="TokenExplorer" (
        echo Running first-time installation for TokenExplorer. Please wait until completion and do not close the console!
        call "%~dp0\..\setup\TokenExplorer_installer.bat"
        set "custom_env_name=TokenExplorer"
        goto :main_menu
    ) else (
...
:eggs
call conda activate %env_name% && cd .. && pip install -e . --use-pep517 && cd TokenExplorer
pause
goto :setup_menu

:logs
cd /d "%~dp0..\TokenExplorer\resources\logs"
del *.log /q
cd ..\..
pause
goto :setup_menu