    ...
    def test_cross_benchmark_shows_diagnostics_for_failed_tokenizer_report(
        ...
        page.route(
            ...
            lambda route: route.fulfill(
                ...
                content_type="application/json",
                body=(
                    '{"reports":[{"report_id":1,"report_version":4,"created_at":"2026-01-01T00:00:00Z",'
        ...
        page.route(
            ...
            lambda route: route.fulfill(
                ...
                content_type="application/json",
                body=(
                    '{"status":"success","schema_version":2,"methodology_version":"semantic_honesty",'
                    '"report_id":1,"report_version":4,"created_at":"2026-01-01T00:00:00Z","run_name":"mock run",'
