    ...
    def test_cross_benchmark_shows_diagnostics_for_failed_tokenizer_report(
        ...
        page.route(
            ...
            lambda route: route.fulfill(
                ...
                content_type="application/json",
                body=(
                    '{"status":"success","schema_version":1,"methodology_version":"v1_observed_trials",'
                    ...
                    '"latency":{"encode_latency_p50_ms":1.0,"encode_latency_p95_ms":2.0,"encode_latency_p99_ms":3.0},'
                    '"fidelity":{"exact_round_trip_rate":1.0,"normalized_round_trip_rate":1.0,'
                    '"unknown_token_rate":0.0,"byte_fallback_rate":0.0,"lossless_encodability_rate":100.0},'
                    ...
                    '"latency":{"encode_latency_p50_ms":0.0,"encode_latency_p95_ms":0.0,"encode_latency_p99_ms":0.0},'
                    '"fidelity":{"exact_round_trip_rate":0.0,"normalized_round_trip_rate":0.0,'
                    '"unknown_token_rate":0.0,"byte_fallback_rate":0.0,"lossless_encodability_rate":0.0},'
                    ...
                    '"per_document_stats":false},"benchmark_timing_boundaries":{"encode_only_definition":"encode only",'
