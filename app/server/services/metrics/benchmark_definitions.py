...
class BenchmarkMetricDefinition:
    ...
    compatible_visualizations: tuple[BenchmarkVisualizationKind, ...] = (BenchmarkVisualizationKind.BAR, BenchmarkVisualizationKind.HORIZONTAL_BAR)
...
BENCHMARK_METRIC_DEFINITIONS: tuple[BenchmarkMetricDefinition, ...] = (
    ...
    *tuple(_definition(f"frag.{key}", "fragmentation", "Fragmentation", label, f"fragmentation.{key}", "ratio", "ratio", default_visible=key == "pieces_per_word_mean") for key, label in (("tokens_per_character", "Tokens per character"), ("characters_per_token", "Characters per token"), ("tokens_per_byte", "Tokens per byte"), ("bytes_per_token", "Bytes per token"), ("pieces_per_word_mean", "Pieces per word"))),
    _definition("frag.fragmentation_by_word_length_bucket", "fragmentation", "Fragmentation", "Word-length bucket comparison", "fragmentation.fragmentation_by_word_length_bucket", "pieces/word", "ratio", default_visualization=BenchmarkVisualizationKind.GROUPED_BAR, compatible_visualizations=(BenchmarkVisualizationKind.GROUPED_BAR,), width=BenchmarkWidgetWidth.WIDE),
